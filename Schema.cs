...
public class Root
{
    [QueryParam] [JsonPropertyName("id")] public Guid Id { get; set; }
    ...
    [JsonPropertyName("projectSlug")] public string ProjectSlug { get; set; }
    ...
    [JsonPropertyName("buildJobId")] public string BuildJobId { get; set; }
    ...
    [JsonPropertyName("commitAuthor")] public string CommitAuthor { get; set; }

    [JsonPropertyName("commitAuthorEmail")]
    public string CommitAuthorEmail { get; set; }

    [JsonPropertyName("commitDate")] public string CommitDate { get; set; }
